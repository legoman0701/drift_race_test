...
# ======= TUTORIAL =======
TUTORIAL_MIN_TIME_SCALE = 0.001
TUTORIAL_SLOWDOWN_RATE = 4.0
TUTORIAL_SPEEDUP_RATE = 2.4
...
TUTORIAL_TURN_ONLY_MIN_TIME_SCALE = 0.12
TUTORIAL_ACCEL_ONLY_MIN_TIME_SCALE = 0.18
...
TUTORIAL_REWIND_SECONDS = 5.0
TUTORIAL_HARD_CRASH_THRESHOLD = 110.0
